...
function dropdownFilter(val){
    ...
    switch(val){
        case 0: {
            y[0].innerHTML = '<i class="fa fa-map-marker fa-lg fa-fw" aria-hidden="true"></i><span class="caret"></span>';
            $("#filter-date").hide();
            $("#filter-location").show();
            break;
        }
        case 1: {
            y[0].innerHTML = '<i class="fa fa-calendar-o fa-lg fa-fw" aria-hidden="true"></i><span class="caret"></span>';
